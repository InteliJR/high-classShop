...
/**
 * DTO para pré-visualização de contrato via DocuSign Sender View
 *
 * Estende os mesmos campos do GenerateContractDto, mas adiciona
 * returnUrl para callback do DocuSign embedded view.
 *
