...
-- DropForeignKey
ALTER TABLE "public"."aircraft_images" DROP CONSTRAINT "aircraft_images_aircraft_id_fkey";
...
-- DropForeignKey
ALTER TABLE "public"."boat_images" DROP CONSTRAINT "boat_images_boat_id_fkey";
