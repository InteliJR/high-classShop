...
export default function ConsultantsPage() {
  ...
  const [isNewConsultantModalOpen, setIsNewConsultantModalOpen] =
    useState(false);
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      const errorMessage =
        ...
        "Erro ao apagar o consultor. Tente novamente.";
      alert(errorMessage);
    } finally {
  ...
  return (
    <div className="text-text-main w-full">
      ...
      <div className="p-6 rounded-lg shadow bg-brand-container bg-bg-container">
        ...
        <p className="text-base mb-8 mt-2">Lista completa de consultores</p>
        ...
        <div className="mt-4 flex flex-col gap-4 max-h-[70vh] overflow-y-auto p-2">
          {filteredConsultants.length === 0 ? (
            <p className="text-center text-gray-500 py-8">
              {searchTerm
                ? "Nenhum consultor encontrado com esse termo de busca."
      ...
      >
        <div className="text-center">
          ...
          <div className="flex justify-center gap-4">
            <Button onClick={() => setConsultantToDelete(null)}>
              Cancelar
            </Button>
