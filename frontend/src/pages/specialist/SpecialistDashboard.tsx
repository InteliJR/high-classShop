...
import { getSpecialistDashboardStats, type SpecialistDashboardStats } from '../../services/dashboard.service';
    ...
    <div className="w-full">
      ...
      <div className="grid grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-gray-300 rounded-lg p-6">
          <p className="text-gray-700 font-semibold mb-2">Produtos Cadastrados</p>
          {isLoading ? (
            <p className="text-2xl font-bold text-gray-900 mb-2">Carregando...</p>
          ) : (
            <>
              <p className="text-4xl font-bold text-gray-900 mb-2">{stats?.productsListed || 0}</p>
        ...
        <div className="bg-gray-300 rounded-lg p-6">
          ...
          {isLoading ? (
            ...
            <>
              <p className="text-4xl font-bold text-gray-900 mb-2">{stats?.completedSales || 0}</p>
        ...
        <div className="col-span-2 bg-white rounded-lg p-6 shadow-sm border border-gray-200">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={MOCK_SALES_BY_MONTH}>
              ...
              <Tooltip />
              <Legend />
              <Line type="monotone" dataKey="naoVendidos" stroke="#EF4444" name="Não vendidos" />
              <Line type="monotone" dataKey="vendidos" stroke="#22C55E" name="Vendidos" />
            </LineChart>
          </ResponsiveContainer>
        </div>
