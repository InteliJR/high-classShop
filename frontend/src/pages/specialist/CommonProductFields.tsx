...
export default function CommonProductFields({ register, errors }: CommonProductFieldsProps) {
  return (
    <>
      {/* Marca */}
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          placeholder="Ex: Ferrari, Azimut, Embraer"
        />
        {errors.marca && (
      ...
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          className="px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          placeholder="Ex: 488 GTB, S6, Phenom 300"
        />
        {errors.modelo && (
