  ...
  return (
    <div className="space-y-4">
      ...
      {cropModal && cropImageIndex !== null && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" onClick={closeCropModal}>
          <div className="bg-white rounded-lg max-w-2xl w-full p-6 space-y-4" onClick={(e) => e.stopPropagation()}>
